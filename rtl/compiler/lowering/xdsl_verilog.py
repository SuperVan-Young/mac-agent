"""Lower an ASAP7-only xDSL module to structural Verilog."""
...
class XdslLoweringResult:
    ir_text: str
    verilog_text: str


def lower_xdsl_asap7_module_to_verilog(module: ModuleOp, top_name: str = "mac16x16p32") -> str:
    wires: set[str] = set()
